...
#grabbed from http://www.roguebasin.com/index.php?title=Bresenham%27s_Line_Algorithm#Python
...
#learned zip,map,lambda for this CTF :-)
topts = zip(raw_arr[::2], raw_arr[1::2])	#creates all points
array = []
for i in xrange(len(topts)-1):
  points = get_line(topts[i],topts[i+1])
  i=i+1
  #print points
  array.append(points)
...
picture= Image.new("RGB",(12913,501))
pic=picture.load()
i=1
total=0
for arr in array:
  ...
  #print arr
  for p in arr:
    #stolen from http://stackoverflow.com/questions/138250/how-can-i-read-the-rgb-value-of-a-given-pixel-in-python
